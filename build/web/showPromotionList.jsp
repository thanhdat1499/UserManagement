...
<html>
    ...
    <body>
        ...
        <div class="container mt-3">
                ...
                <h2 style="color: fuchsia">Welcome ${sessionScope.user.displayName} To Promotion Page!</h2>
                <br>
                        ...
                        <tbody>
                            <c:forEach items="${listPromotion}" var="P" varStatus="track">
                                <tr>
                                    ...
                                    <td><a class="btn btn-danger" href="DeletePromotionController?id=${P.userId}" onclick="return confirm('Are you sure you want to delete this user ?');">Delete</a></td>                                             
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
